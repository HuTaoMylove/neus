...
import os
from utils import extract_fields, extract_geometry
import trimesh
from PE import PE
import numpy as np
...
class SDFNetwork(nn.Module):
    ...
    def save_mesh(self, save_path=None, resolution=256, threshold=10, bound_min=torch.tensor([-1.2, -1.2, -0.45]),
                  bound_max=torch.tensor([1.2, 1.2, 1.]),
